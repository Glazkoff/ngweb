...
function services_post_type_messages($messages)
{
	...
	$messages["services"] = [
		// services - название созданного нами типа записей
		0 => "", // Данный индекс не используется.
		1 => sprintf(
			'Услуга обновлена. <a href="%s">Просмотр</a>',
		...
		5 => isset($_GET["revision"])
			? sprintf(
				"Услуга восстановлена из редакции: %s",
				wp_post_revision_title((int) $_GET["revision"], false)
			)
			: false,
		6 => sprintf(
			'Услуга опубликована на сайте. <a href="%s">Просмотр</a>',
			esc_url(get_permalink($post_ID))
		),
		7 => "Услуга сохранена.",
		8 => sprintf(
